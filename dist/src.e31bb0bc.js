...
},{}],"load-more.js":[function(require,module,exports) {
"use strict";
...
},{}],"fetchIt.js":[function(require,module,exports) {
"use strict";
...
class FetchImages {
  ...
  async getImages() {
    const response = await fetch(`${BASE_URL}/?key=${KEY}&q=${this.query}&image_type=photo&orientation=horizontal&safesearch=true&per_page=40&page=${this.page}`);
  ...
  showTotalHits(hits) {
    _notiflix.default.Notify.success(`Hooray! We found ${hits} images.`);
  }
...
},{"notiflix":"../node_modules/notiflix/dist/notiflix-aio-3.2.2.min.js","./load-more":"load-more.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
var _fetchIt = _interopRequireDefault(require("./fetchIt.js"));
...
const fetchImages = new _fetchIt.default();
const loadMoreBtn = new _loadMore.default({
  selector: '[data-action="load-more"]',
  hidden: true
});
...
},{"./fetchIt.js":"fetchIt.js","./load-more":"load-more.js","./css/styles.css":"css/styles.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
